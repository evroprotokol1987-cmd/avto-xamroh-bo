...
BOT_TOKEN = "8265175906:AAFo4yBtH4ri291UgLycypxVRAiBlNQpoHk"
...
async def start_handler(message: types.Message):
    ...
    builder.button(text="📞 Admin / Tel: +998 33 559-20-20", url="https://t.me/premier_pro_taxi")
    builder.button(text="🤖 Yandex rasmiy boti", url="https://t.me/yandex_rasmiy_bot")
    builder.button(text="🚗 Evrotokol / Avtobaholash / Sug'urta", url="https://t.me/premier_pro_taxi")
    ...
    builder.button(text="📢 Telegram kanal", url="https://t.me/yandex_rasmiy")
    builder.button(text="📸 Instagram", url="https://www.instagram.com/yandex_rasmiy")
    builder.button(text="📺 YouTube", url="https://www.youtube.com/@yandex_rasmiy")
    builder.adjust(1)

    welcome_text = (
        "Assalomu alaykum! **TEZKOR AVTO XIZMAT** va "
        "**PREMIER PRO TAXI** rasmiy botiga xush kelibsiz.\n\n"
        "Taxoparkga ulanish, evrotokol, avtobaholash, avtosug'urta va "
        "boshqa xizmatlar uchun biz bilan bog'laning:\n"
        "📞 Telefon: **+998 33 559-20-20**\n"
        "👤 Telegram profil: https://t.me/premier_pro_taxi\n\n"
